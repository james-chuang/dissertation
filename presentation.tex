...
\tikzset{
        ...
        rnastyle/.style={
            ...
            line width=3pt,
            decorate,
            decoration={coil, aspect=0, segment length=14pt}},
        nucleosome/.style={
            fill=sandybrown!60,
            fill opacity=.9,
            draw=none},
        ...
        pol/.pic={
            ...
            opacity=0.98]
                ...
                \node [circle, fill=black!60, minimum width=9pt, inner sep=0pt] at (0,-0.05) {};
        },
        pics/rna/.style ={
            code={
                \node [circle, fill=black!60, minimum width=9pt, inner sep=0pt] at (0,-0.05) {};
                \draw [rnastyle] (0,0) to [bend left=15] ($(0,0) + (150:#1)$);
            }
        }
}
...
\begin{frame}{transcription}
    \begin{adjustbox}{center}
        \begin{tikzpicture}[scale=0.5, every node/.style={scale=0.5}]
            \pic {chromatin={1, 2, 4, 5, ..., 8}{8}};
            \pic [rotate=10] at (midpoint-4) {pol};
            \draw [wrapping] (midpoint-4) to [bend left=10] (wrapping-end-2);
            \pic at (midpoint-5) {pol};
            \draw [wrapping] (midpoint-5) to [bend left=10] (wrapping-end-4);
            \pic at ($(midpoint-5) + (90:0.6) $) {rna={2}};
            \pic at (midpoint-7) {pol};
            \draw [wrapping] (midpoint-7) to [bend left=10] (wrapping-end-6);
            \pic at ($(midpoint-7) + (90:0.6) $) {rna={5}};
        \end{tikzpicture}
    \end{adjustbox}
\end{frame}
