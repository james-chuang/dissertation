    ...
    \begin{adjustbox}{center}
        \begin{tikzpicture}[scale=0.5, every node/.style={scale=0.5}]
            ...
            \uncover<2->{
                ...
                \node[font=\Huge, align=center, anchor=south] at (midpoint-3 |- 0,5) {RNA polymerase II\\ \\initiation};
            }
            \uncover<5->{
            ...
            \uncover<3->{
                ...
                \node [font=\Huge, anchor=south] at (midpoint-5 |- 0,5) {elongation};
            }
            \uncover<5>{
            ...
            \uncover<4->{
                ...
                \node [font=\Huge, anchor=south] at (midpoint-7 |- 0,5 ) {termination};
            }
            \uncover<5->{
