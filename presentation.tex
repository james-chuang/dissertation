...
\begin{frame}{The scientific process}
    ...
    \begin{tikzpicture}[align=center, text depth=.25em, line width=4pt, >=latex, font=\large, color=blue, text=black]
        ...
        \uncover<2->{\draw [->] (bottomleft) to [bend right=60]
            ...
            node[anchor=west, align=left] (results1) {{\uncover<3->{...get a PhD? {\tiny (please)}}}};}
...
\begin{frame}[t, plain]
    ...
    \begin{tikzpicture}
        ...
        \uncover<2->{\node [anchor=north east, font=\footnotesize] at (rulegraph.south east) {Köster and Rahmann (2012). \textit{Bioinformatics}};}
...
\begin{frame}[t,plain]
    \begin{tikzpicture}[remember picture, overlay, inner sep=0]
        \node [anchor=north] at (current page.north) {\includegraphics[height=\paperheight]{figures/montage.png}};
    \end{tikzpicture}
\end{frame}

\begin{frame}[t,plain]
    \begin{tikzpicture}[remember picture, overlay, inner sep=0]
        \node [anchor=north] at (current page.north) {\includegraphics[width=\paperwidth]{figures/zenodo_screenshot.png}};
    \end{tikzpicture}
\end{frame}
    ...
    \begin{adjustbox}{center}
        \begin{tikzpicture}[scale=0.5, every node/.style={scale=0.5}]
            ...
            \uncover<2->{
                ...
                \node[font=\Huge, text height=1.5ex, text depth=0.25ex] at (midpoint-3 |- 0,5) {initiation};
                \node[font=\Huge] at (midpoint-3 |- 0,7) {RNA polymerase II};
            }
            \uncover<5->{
            ...
            \uncover<3->{
                ...
                \node [font=\Huge, text height=1.5ex, text depth=0.25ex] at (midpoint-5 |- 0,5) {elongation};
            }
            \uncover<5>{
            ...
            \uncover<4->{
                ...
                \node [font=\Huge, text height=1.5ex, text depth=0.25ex] at (midpoint-7 |- 0,5 ) {termination};
            }
            \uncover<5->{
    ...
    \begin{adjustbox}{center}
        \begin{tikzpicture}[>=latex]
            ...
            \uncover<3>{
                ...
                \draw [<->, color=black!70, line width=2pt] (spt6) to [bend left=40] (histone);
            }
            \uncover<2->{
                \node [] (spn1) at (3, 7.5) {Spn1/Iws1};
                \draw [<->, color=black!70, line width=2pt] (spt6.west) to [bend left=40] (spn1.west);
            }
            \node [align=left,
...
\begin{frame}[t]
    \centering
    \begin{tikzpicture}[overlay, shift={(0,-3.3)}]
        \node<1-2>[inner sep=0] (marker) at (0,0) {\includegraphics[width=\textwidth]{figures/presentation/presentation_six_tss_seq_heatmaps.pdf}};
        \fill<1>[white] (marker.south east) rectangle (marker.north);
    \end{tikzpicture}
\end{frame}

\begin{frame}{Genic transcript abundances are reduced in \textit{spt6-1004}}
    \centering
    \begin{columns}
        \begin{column}{0.5\textwidth}
...
\begin{frame}[t]
    \begin{tikzpicture}
        \node<1>[inner sep=0] (marker) at (0,0) {\includegraphics[width=\textwidth]{figures/presentation/presentation_six_mnase_metagene0001.pdf}};
        \fill<1>[white] (-0.7,0.49) rectangle (2.2, 1.01);
        \node<2>[inner sep=0] at (marker) {\includegraphics[width=\textwidth]{figures/presentation/presentation_six_mnase_metagene0002.pdf}};
        \pic [yscale=0.3, xscale=0.234, transform shape] at ($(marker.south west) +(2.55cm,-0.5cm)$) {chromatin={1, 2, ..., 8}{8}};
    \end{tikzpicture}
\end{frame}
    ...
    \begin{adjustbox}{center}
        \begin{tikzpicture}[scale=0.5, every node/.style={scale=0.5}, overlay]
            ...
            \uncover<3>{
                ...
                \draw [wrapping] (midpoint-8) to [bend left=9.66] (wrapping-end-4);
            ...
            \uncover<3>{
                ...
                \draw [wrapping] (midpoint-6) to [bend right=4] (wrapping-start-6);
    ...
    \begin{columns}
        \begin{column}{0.45\textwidth}
            \begin{tikzpicture}[x=6.3cm, y=0.3cm, >=latex, font=\normalsize, text=black]
                ...
                \draw [|-, line width=2pt, color=black!70, text=black] (promoter) -- ++(0, 3) node [anchor=south] (thiamine) {thiamine};
                ...
                \draw [->, line width=2pt, color=black!70, text=black] (spt5) --
                    coordinate[pos=0.4] (auxincoord)
                    coordinate[pos=0.6] (auxintarget) (degraded);
                \draw [text=black] (auxincoord |- 0,9) node (auxin) {auxin};
