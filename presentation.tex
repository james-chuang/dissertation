...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\textwidth]{figures/presentation/presentation_six_spt6_western.pdf}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}
                \draw [line width=1pt, color=gray] (0,0) -- (7,0);
            \end{tikzpicture}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    \includegraphics[width=\textwidth]{figures/six/six_aat_assay_comparison.pdf}
\end{frame}

\begin{frame}
    \includegraphics[width=\textwidth]{figures/six/six_tss_seq_heatmaps.pdf}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\textwidth]{figures/six/six_tss_diffexp_summary.pdf}
        \end{column}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\textwidth]{figures/six/six_tss_expression_levels.pdf}
        \end{column}
    \end{columns}
\end{frame}

\begin{frame}
    \includegraphics[width=\textwidth]{figures/six/six_tfiib_heatmap.pdf}
\end{frame}

\begin{frame}
    \includegraphics[width=\textwidth]{figures/six/six_tfiib_spreading_ssa4.pdf}
\end{frame}

\begin{frame}
    \includegraphics[width=\textwidth]{figures/six/six_tss_v_tfiib.pdf}
\end{frame}

\begin{frame}
    \includegraphics[width=\textwidth]{figures/six/six_mnase_metagene.pdf}
\end{frame}

\begin{frame}
    \includegraphics[width=\textwidth]{figures/six/six_intragenic_mnase_metagenes.pdf}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\textwidth]{figures/six/six_tss_seqlogos.pdf}
        \end{column}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\textwidth]{figures/six/six_intragenic_tata.pdf}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\textwidth]{figures/five/five_summary_metagenes.pdf}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    \includegraphics[width=\textwidth]{figures/five/five_rnaseq_metagene.pdf}
\end{frame}
