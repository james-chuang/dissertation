...
\begin{frame}[t]
    \centering
    \begin{tikzpicture}
        \node[align=center] at (-2.5, 5.5){\large generate \\ \large hypotheses};
        \draw [->, line width=3pt] (-2.5, 6) to [out=80, in=190] (-0.75, 7);
        \node[align=center] at (0, 7){\large collect \\ \large data};
        \draw [->, line width=3pt] (0.75, 7) to [out=350, in=100] (2.5, 6);
        \node[align=center] at (2.5, 5.5){\large analyze \\ \large data};
        \draw [->, line width=3pt] (2.4, 4.85) to [out=210, in=330] (-2.4, 4.85);
        \draw [->, line width=3pt] (2.4, 4.85) to [out=210, in=70] (0, 3.25);
        \node[align=left] at (0, 2.25){\large publications \\
                                        \large .....PhD? \\
                                        \large ..........\$\$\$\$?? \\
                                        \large ...............Nobel prize?!?!?};
    \end{tikzpicture}
...
\begin{frame}[plain]
    \centerline{\includegraphics[width=\paperwidth]{figures/montage.png}}
\end{frame}
