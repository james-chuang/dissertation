...
\begin{figure}[h]
    \centering
    \includegraphics[width=6in]{figures/five/five_rnaseq_metagene.pdf}
...
\begin{figure}[h]
    ...
    \caption[Average MNase-seq dyad signal and GC content in Spt5-depleted and non-depleted cells, flanking all antisense TSSs upregulated in Spt5-depleted cells (right panels), as well as all genic TSSs detected in non-depleted cells (left panels).]{
