...
One possible candidate is serine 7 phosphorylation, a modification made early in transcription initiation which has been shown in an \textit{in vitro} human system to be a preferred substrate for P-TEFb to carry out phosphorylation of serine 5 \citep{czudnochowski2012}.
...
\end{figure}
Given the transcriptional changes observed after Spt5 depletion, we performed RNA-seq and TSS-seq to further see how steady-state transcript levels are affected.
Changes to the levels of genic transcripts after Spt5 depletion are generally mild, with the median gene being expressed at roughly 68\% of non-depleted levels as measured by RNA-seq with an RNA spike-in, or at 104\% of non-depleted levels as measured by TSS-seq with a cell spike-in.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=4in]{figures/five/five_rnaseq_metagene.pdf}
...
Interestingly, the top motif found by \textit{de novo} motif discovery upstream of Spt5-repressed antisense TSSs is a GA-rich motif with 3-nucleotide periodicity, similar to the top motif found upstream of Spt6-repressed intragenic and antisense TSS in \textit{S. cerevisiae} (Figure \ref{fig:five_meme_motifs}).
\begin{figure}[h]
    \centering
