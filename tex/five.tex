...
The results are presented below, with sections \ref{sec:five_pol_ii} and \ref{sec:five_rna_seq} describing reanalyses of data published in \citet{shetty2017} prior to my involvement in this project.
