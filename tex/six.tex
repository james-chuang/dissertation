...
Changes in TSS-seq signal in \textit{spt6-1004} are associated with a change in TFIIB signal of the same sign at over 82\% of TSSs of any genomic class \ref{fig:six_tss_v_tfiib}, indicating that the increase in intragenic transcript levels and decrease in genic transcript levels observed in \textit{spt6-1004} are in large part explained by changes in transcription initiation.
...
\subsection{Enrichment of the TATA box at intragenic TSSs}
...
\subsection{\textit{De novo} motif discovery at intragenic TSSs}
