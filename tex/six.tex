\chapter{Genomics of the transcription elongation factor Spt6}
\label{chapter:six}
...
The results presented in this chapter are the product of updated versions of the analyses published in \citet{doris2018}.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=5in]{figures/six/six_tfiib_heatmap.pdf}
...
\subsubsection[Reannotation of \textit{S. cerevisiae} TSSs\\ using TSS-seq data]{Reannotation of \textit{S. cerevisiae} TSSs using TSS-seq data}
...
\subsubsection[Classification of TFIIB ChIP-nexus peaks\\ into genomic categories]{Classification of TFIIB ChIP-nexus peaks into genomic categories}
