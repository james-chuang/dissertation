...
As Spt6 is essential for viability in \textit{S. cerevisiae}, many of these studies make use of the same temperature-sensitive \textit{spt6} mutant used in this project, \textbf{\textit{spt6-1004}}, which encodes an in-frame deletion of a helix-hairpin-helix domain within Spt6 \citep{kaplan2003}.
When \textit{spt6-1004} cells are shifted from 30\textdegree C to 37\textdegree C for 80 minutes, bulk Spt6 protein levels are depleted to about 20\% of wild-type levels.
The most notable phenotype of the \textit{spt6-1004} mutant is the appearance of \textbf{intragenic transcripts}, transcripts which arise from within protein-coding sequences, in both sense and antisense orientations relative to the coding gene (Figure \ref{fig:six_gene_diagram}) \citep{cheung2008, degennaro2013, kaplan2003, uwimana2017}.

\begin{SCfigure}[40][h]
    \centering
    \includegraphics[width=4in]{figures/six/six_aat_assay_comparison.pdf}
...
The TSS-seq data were quantified by peak calling and differential expression analysis, and classified into genomic categories based on their position relative to coding genes (Figure \ref{fig:six_tss_diffexp_summary}).
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{2.875in}
        \centering
        \includegraphics[width=2.875in]{figures/six/six_tss_expression_levels.pdf}
...
\begin{figure}
\centering
\includegraphics[width=3in]{figures/six/six_intragenic_genes_bvenn.pdf}
    \caption[Set plot of the number of genes with \textit{spt6-1004}-induced intragenic transcripts discovered in \citet{cheung2008}, \citet{uwimana2017}, and our TSS-seq data.]{}
...
\begin{SCfigure}[50][h]
\centering
\includegraphics[width=4in]{figures/six/six_tfiib_spreading_ssa4.pdf}
...
\begin{sidewaysfigure}
    ...
    \caption[Average wild-type and \textit{spt6-1004} MNase-seq dyad signal around all \textit{spt6-1004}-induced intragenic TSSs, grouped by a self-organizing map of the MNase-seq signal.]{bar}
...
\caption[Average wild-type and \textit{spt6-1004} MNase-seq dyad signal and GC content for three clusters of \textit{spt6-1004}-induced intragenic TSSs, as well as genic TSSs.]{
