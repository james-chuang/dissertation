...
theme_default = theme_light() +
    theme(text = element_text(size=10, color="black", face="plain", family="FreeSans"),
          axis.text = element_text(size=8, color="black", face="plain"),
          ...
          plot.title = element_text(size=10, color="black", face="plain", margin=margin(0,0,1,0,"pt")),
...
theme_heatmap = theme_minimal() +
    theme(text = element_text(size=10, color="black", face="plain", family="FreeSans"),
          ...
          legend.title = element_text(size=10, margin=margin(0,0,0,0,"pt")),
          legend.text = element_text(size=8, margin=margin(0,0,0,0,"pt"), vjust=1),
          legend.margin = margin(0,0,0,0,"pt"),
          legend.box.margin = margin(0,0,0,0,"pt"),
          ...
          strip.text = element_blank(),
          axis.text.x = element_text(size=10, color="black", margin=margin(t=1, unit="pt")),
...
theme_heatmap_presentation = theme_minimal() +
    theme(text = element_text(size=12, color="black", face="plain", family="FreeSans"),
          legend.position = "top",
          legend.justification = c(0.5, 0.5),
          legend.title = element_text(size=12, margin=margin(0,0,-4,0,"pt")),
          legend.text = element_text(size=6, margin=margin(-4,0,0,0,"pt"), vjust=1),
          legend.margin = margin(0,0,0,0,"pt"),
          legend.box.margin = margin(0,0,0,0,"pt"),
          legend.box.spacing = unit(0, "pt"),
          panel.spacing.x = unit(2, "pt"),
